...
def main():
    ...
    print("Selecting top 20 AR events and top 20 non-AR events...")
    ...
    top_20_ar = ar_events_sorted.head(20)['date'].values
    top_20_non_ar = non_ar_events_sorted.head(20)['date'].values
