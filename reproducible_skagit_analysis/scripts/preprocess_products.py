...
INPUT_CSV = os.path.join(BASE_DIR, "reproducible_skagit_analysis", "data", "clean_bias_table.csv")
OUTPUT_CSV = os.path.join(BASE_DIR, "reproducible_skagit_analysis", "data", "prepared_bias_table.csv")
