"""Generate spatial maps of AR event precipitation across weather products (3-day windows).

Extracts 3-day cumulative precipitation (T-2 to T) for 6 selected atmospheric river
