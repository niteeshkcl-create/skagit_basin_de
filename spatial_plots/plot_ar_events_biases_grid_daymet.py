...
OUT_DIR = os.path.join("/data0/hernanqd/plots_code/spatial_plots/plots/plot_ar_events_biases_grid_daymet")
...
def main():
    ...
    if len(all_diffs):
        ...
        vmax_diff = 10.0
    vmin_diff = -vmax_diff
    print(f"Global bias color range: {vmin_diff} to {vmax_diff} mm/day")
