"""
plot_ar_events_spatial_grid.py
------------------------------
...
Output: jun 8/ar_events_spatial_comparison.png
"""
...
OUT_DIR = os.path.join("/data0/hernanqd/plots_code/skagit_basin_de/spatial_plots/plots/plot_non_ar_events_spatial_grid")
