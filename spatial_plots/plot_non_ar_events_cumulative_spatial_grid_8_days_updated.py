"""Generate spatial maps of non-AR event precipitation across weather products (8-day windows).
...
def main():
    ...
    out_png = os.path.join(OUT_DIR, "non_ar_events_cumulative_spatial_grid_8_days.png")
