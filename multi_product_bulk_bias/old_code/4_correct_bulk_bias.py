...
BULK_CSV = os.path.join(BASE_DIR, "outputs/multi_product_bulk_bias_data.csv")
OUTPUT_CSV = os.path.join(BASE_DIR, "outputs/multi_product_bulk_bias_data.csv")
...
def process_year(year, event_dates, masks_2d):
    ...
    # Construct the set of all window dates (T-1, T, T+1)
    window_dates = set()
    ...
    # Calculate 3-day window totals and maximums
    results = []
    for dt in event_dates:
        w_dates = [dt - pd.Timedelta(days=1), dt, dt + pd.Timedelta(days=1)]
        row = {'date': dt}
...
def main():
    ...
    # Recalculate biases
    print("Recalculating biases...")
    df_bulk_updated['bias_tot_PNNL_PRISM'] = df_bulk_updated['pnnl_3d_tot'] - df_bulk_updated['prism_3d_tot']
    df_bulk_updated['bias_max_PNNL_PRISM'] = df_bulk_updated['pnnl_3d_max'] - df_bulk_updated['prism_3d_max']
    df_bulk_updated['bias_tot_PRISM_ORNL'] = df_bulk_updated['prism_3d_tot'] - df_bulk_updated['daymet_3d_tot']
    df_bulk_updated['bias_max_PRISM_ORNL'] = df_bulk_updated['prism_3d_max'] - df_bulk_updated['daymet_3d_max']
    df_bulk_updated['bias_tot_PRISM_ORNL_mean'] = df_bulk_updated['prism_3d_tot'] - df_bulk_updated['ornl_mean_3d_tot']
    df_bulk_updated['bias_max_PRISM_ORNL_mean'] = df_bulk_updated['prism_3d_max'] - df_bulk_updated['ornl_mean_3d_max']
    df_bulk_updated['bias_tot_PRISM_ORNL_median'] = df_bulk_updated['prism_3d_tot'] - df_bulk_updated['ornl_median_3d_tot']
    df_bulk_updated['bias_max_PRISM_ORNL_median'] = df_bulk_updated['prism_3d_max'] - df_bulk_updated['ornl_median_3d_max']
    df_bulk_updated['bias_tot_PRISM_CONUS'] = df_bulk_updated['prism_3d_tot'] - df_bulk_updated['conus_3d_tot']
    df_bulk_updated['bias_max_PRISM_CONUS'] = df_bulk_updated['prism_3d_max'] - df_bulk_updated['conus_3d_max']
    df_bulk_updated['bias_tot_PRISM_HRRR'] = df_bulk_updated['prism_3d_tot'] - df_bulk_updated['hrrr_3d_tot']
    df_bulk_updated['bias_max_PRISM_HRRR'] = df_bulk_updated['prism_3d_max'] - df_bulk_updated['hrrr_3d_max']
    df_bulk_updated['bias_tot_PRISM_UCLA'] = df_bulk_updated['prism_3d_tot'] - df_bulk_updated['ucla_3d_tot']
    df_bulk_updated['bias_max_PRISM_UCLA'] = df_bulk_updated['prism_3d_max'] - df_bulk_updated['ucla_3d_max']
    df_bulk_updated['bias_tot_PRISM_GRIDMET'] = df_bulk_updated['prism_3d_tot'] - df_bulk_updated['gridmet_3d_tot']
    df_bulk_updated['bias_max_PRISM_GRIDMET'] = df_bulk_updated['prism_3d_max'] - df_bulk_updated['gridmet_3d_max']
