...
INPUT_CSV = os.path.join(BASE_DIR, "experiments_4", "multi_product_bulk_bias_data.csv")
OUTPUT_CSV = os.path.join(BASE_DIR, "reproducible_skagit_analysis", "data", "clean_bias_table.csv")
